...
const Post = () => {
  ...
  /* Hook do react-router que permite ultilizar recursos de navegação no histórico do navegador */
    ...
    async function getPost() {
      try {
        ...
        if (Object.keys(dados).length === 0) {
          /* Estando, forçamos o redirecionamento numa rota de primeiro nível que não existe. Com isso, na prática, o router traz o página404 */
          history.push("/404");
        }
      } catch (error) {
